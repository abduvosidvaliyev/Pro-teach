...
const DelateNotify = ({ DelateTitle, Icon }) => {
    toast.success(
        <div className="flex items-center justify-between w-full">
            ...
            <span className="text-lg" style={{ color: "#ff0000" }}>{DelateTitle ? DelateTitle : "O‘chirildi!"}</span>
        </div>,
        {
            autoClose: 3000,
...
const AddNotify = ({ AddTitle }) => {
    toast.success(
        <div className="flex items-center justify-between w-full">
            ...
            <span className="text-lg" style={{ color: "#078625" }}>{AddTitle ? AddTitle : "Qo‘shildi!"}</span>
        </div>,
        {
            autoClose: 3000,
            hideProgressBar: false,
...
const ChengeNotify = ({ ChengeTitle }) => {
    toast.success(
        <div className="flex items-center justify-between w-full">
            ...
            <span className="text-lg" style={{ color: "#5f54fe" }}>{ChengeTitle ? ChengeTitle : "Ma'lumot o‘zgartirildi!"}</span>
        </div>,
        {
            autoClose: 3000,
            hideProgressBar: false,
...
const CompletedNotify = () => {
    toast.success(
        <div className="flex items-center justify-between w-full">
            <FiPlusCircle size={25} color="#078625" />
            <span className="text-lg" style={{ color: "#078625" }}>Tugatilwdi!</span>
        </div>,
        {
            autoClose: 3000,
            hideProgressBar: false,
